...
Descrição: projeto para criação de clientes(MarketPlace).
...
Passo 2: acesse o repositório customer-service
...
Ou rode via terminal: acesse a seguinte pasta customer-service/build/libs e rode o comando java -jar customer-service-0.0.1-SNAPSHOT.jar

Para acessar o Swagger da aplicação o utilize a rota: http://localhost:8081/api/customer-service/swagger-ui.html
